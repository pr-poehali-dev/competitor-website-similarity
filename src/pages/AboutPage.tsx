        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div>
            <p className="text-gray-300 leading-relaxed mb-4">
              <strong className="text-white">НПФ ТАРЕКСА</strong> — российский поставщик кварцевых материалов, сорбентов и фильтрующих загрузок для B2B рынка. Работаем напрямую с промышленными предприятиями, водоканалами, строительными компаниями и научными организациями по всей России.
            </p>
            <p className="text-gray-300 leading-relaxed mb-4">
              Наш ассортимент: кварцевые пески и кварц дроблёный, гидроантрацит Aqualat, гравий и щебень, мраморная крошка, природный цеолит и активированный уголь. Все материалы соответствуют ГОСТ и сопровождаются полным комплектом документации.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Поставки по всей территории России — от Калининграда до Владивостока, от Мурманска до Махачкалы. Для крупных партий — специальные логистические решения.
            </p>
          </div>
